...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('/packages/icon-line/css/simple-line-icons.css') }}">
  <link rel="stylesheet" href="{{ asset('/packages/icon-etlinefont/style.css') }}">
  <link rel="stylesheet" href="{{ asset('/packages/icon-line-pro/style.css') }}">
  <link rel="stylesheet" href="{{ asset('/packages/icon-hs/style.css') }}">

  <link rel="stylesheet" href="{{ asset('/packages/hs-admin-icons/hs-admin-icons.css') }}">

  <link rel="stylesheet" href="{{ asset('/packages/animate.css') }}">
  <link rel="stylesheet" href="{{ asset('/packages/malihu-scrollbar/jquery.mCustomScrollbar.min.css') }}">

  <link rel="stylesheet" href="{{ asset('/packages/flatpickr/dist/css/flatpickr.min.css') }}">
  ...
  <link rel="stylesheet" href="{{ asset('/packages/hamburgers/hamburgers.min.css') }}">

  <!-- CSS Unify -->
  <link rel="stylesheet" href="{{ asset('/css/unify-admin.css') }} ">
</head>
...
<body>
              ...
              <ul class="p-0 mb-0">
                ...
                <li class="media g-pos-rel u-header-dropdown-item-v1 g-pa-20">
                  <div class="d-flex g-mr-15">
                    <img class="g-width-40 g-height-40 rounded-circle" src="../../assets/img-temp/100x100/img5.jpg" alt="alt">
                  </div>
                ...
                <li class="media g-pos-rel u-header-dropdown-item-v1 g-pa-20">
                  <div class="d-flex g-mr-15">
                    <img class="g-width-40 g-height-40 rounded-circle" src="../../assets/img-temp/100x100/img6.jpg" alt="alt">
                  </div>
                ...
                <li class="media g-pos-rel u-header-dropdown-item-v1 g-pa-20">
                  <div class="d-flex g-mr-15">
                    <img class="g-width-40 g-height-40 rounded-circle" src="../../assets/img-temp/100x100/img7.jpg" alt="alt">
                  </div>
            ...
            <div class="g-pos-rel g-px-10--lg">
              ...
              data-dropdown-animation-in="fadeIn" data-dropdown-animation-out="fadeOut">
                <span class="g-pos-rel">
                  ...
                  <img class="g-width-30 g-width-40--md g-height-30 g-height-40--md rounded-circle g-mr-10--sm" src="../assets/img-temp/130x130/img1.jpg" alt="alt">
                </span>
              ...
              <ul id="profileMenu" class="g-pos-abs g-left-0 g-width-100x--lg g-nowrap g-font-size-14 g-py-20 g-mt-17 rounded" aria-labelledby="profileMenuInvoker">
                ...
                <li class="g-mb-10">
                  <a class="media g-color-lightred-v2--hover g-py-5 g-px-20" href="{{ route('profile') }}">
                    <span class="d-flex align-self-center g-mr-12">
        ...
        <ul id="sideNavMenu" class="u-sidebar-navigation-v1-menu u-side-nav--top-level-menu g-min-height-100vh mb-0">
          ...
          <li class="u-sidebar-navigation-v1-menu-item u-side-nav--has-sub-menu u-side-nav--top-level-menu-item u-side-nav-opened has-active">
            ...
            <ul id="subMenu2" class="u-sidebar-navigation-v1-menu u-side-nav--second-level-menu mb-0" style="display: block;">
              ...
              <!-- Light Layout -->
              <li class="u-sidebar-navigation-v1-menu-item u-side-nav--second-level-menu-item">
                <a class="media u-side-nav--second-level-menu-link g-px-15 g-py-12 active" href="../layout-settings/layout-light.html">
                  <span class="d-flex align-self-center g-mr-15 g-mt-minus-1">
  ...
  <script src="{{ asset('/packages/jquery-migrate/jquery-migrate.min.js') }}"></script>

  <script src="{{ asset('/packages/popper.min.js') }}"></script>
  <script src="{{ asset('/packages/bootstrap/bootstrap.min.js') }}"></script>

  <script src="{{ asset('/packages/cookiejs/jquery.cookie.js') }}"></script>


  <!-- jQuery UI Core -->
  <script src="{{ asset('/packages/jquery-ui/ui/widget.js') }}"></script>
  <script src="{{ asset('/packages/jquery-ui/ui/version.js') }}"></script>
  <script src="{{ asset('/packages/jquery-ui/ui/keycode.js') }}"></script>
  <script src="{{ asset('/packages/jquery-ui/ui/position.js') }}"></script>
  <script src="{{ asset('/packages/jquery-ui/ui/unique-id.js') }}"></script>
  <script src="{{ asset('/packages/jquery-ui/ui/safe-active-element.js') }}"></script>

  <!-- jQuery UI Helpers -->
  <script src="{{ asset('/packages/jquery-ui/ui/widgets/menu.js') }}"></script>
  <script src="{{ asset('/packages/jquery-ui/ui/widgets/mouse.js') }}"></script>

  <!-- JS Plugins Init. -->
  <script src="{{ asset('/packages/appear.js') }}"></script>
  <script src="{{ asset('/packages/bootstrap-select/js/bootstrap-select.min.js') }}"></script>
  <script src="{{ asset('/packages/flatpickr/dist/js/flatpickr.min.js') }}"></script>
  <script src="{{ asset('/packages/malihu-scrollbar/jquery.mCustomScrollbar.concat.min.js') }}"></script>
